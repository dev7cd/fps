...
class SpatialGrid:
    ...
    def __init__(self, box_dims: np.ndarray, cell_size: float):
        ...
        @param box_dims Dimensions du domaine (Lx, Ly, Lz).
        @param cell_size Taille d'une cellule cubique de la grille.
        """
    ...
    def _get_cell_coords(self, point: np.ndarray) -> Tuple[int, int, int]:
        ...
        @param point Coordonnées (x, y, z).
        @return Tuple d'indices entiers (ix, iy, iz).
        """
    ...
    def add_fiber(self, fiber: Any):
        ...
        @param fiber Instance de la classe Fiber à indexer.
        """
    ...
    def remove_fiber(self, parent_id: int):
        ...
        @param parent_id Identifiant unique de la fibre parente à retirer.
        """
    ...
    def query_neighbors(self, bbox: Tuple[np.ndarray, np.ndarray], exclude_id: int) -> List[Any]:
        ...
        @param bbox Tuple (p_min, p_max) définissant la zone de recherche.
        @param exclude_id Identifiant de la fibre à exclure des résultats (souvent soi-même).
        @return Liste d'objets Fiber potentiellement en collision.
        """
        p_min, p_max = bbox
