...
class FiberPackingConfig:
    ...
    def box_volume(self) -> float:
        """!
        @brief Calcule le volume total du domaine RVE.
        @return float Volume total du domaine RVE.
        """
    ...
    def estimate_radius_if_needed(self, estimated_num_fibers: int = 200):
        ...
        @param estimated_num_fibers int Nombre estimé de fibres pour le calcul.
        """
    ...
    def __post_init__(self):
        """!
        @brief Initialisation post-construction pour estimer le rayon si nécessaire.
        """
